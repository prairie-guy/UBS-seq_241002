...
def extract_motifs(input_file, output_file, motif_length, reference_fasta, field_indices):
    chrom_idx, pos_idx, strand_idx = [index - 1 for index in field_indices] # Convert 1-based indices to 0-based indices
...
def main():
    ...
    extract_motifs(args.input_file, args.output_file, args.motif_length, args.reference_fasta, args.field_indices)
